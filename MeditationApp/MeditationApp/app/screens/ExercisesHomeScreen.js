...
import FontAwesome5Icons, { FA5Style } from 'react-native-vector-icons/FontAwesome5';
...
let exercises = [
  ...
  },
  {
    ...
    subTitle:
      'Live happier and healthier by learning the fundamentals of stretch exercises',
...
// Designs the layout of the exercise cards
const ExerciseHomeScreen = ({navigation}) => {
  const ExerciseItem = ({exercise}) => {
    return (
      <TouchableOpacity //determines what opacity of wrapped view should be when touch is active
        onPress={() =>
  ...
  return (
    <SafeAreaView style={{flex: 1, position: 'relative'}}>
      ...
      <View
        ...
        <View
          ...
          <View
            ...
            <View
              style={{ //top line for circle design in top right corner
                height: 3,
                backgroundColor: COLORS.white,
                width: '40%',
                marginBottom: 8,
            ...
            <View
              style={{ //bottom line for circle design in top right corner
                height: 3,
                backgroundColor: COLORS.white,
                width: '40%',
                marginLeft: 5,
        ...
        <Text style={{fontSize: 40, lineHeight: 50, fontWeight: "600"}}>
          Good Morning David!
        </Text>
        <View
          style={{
     ...
     {/* creating the columns for the exercises cards */}
      <FlatList // displays similar structured data in scrollable list
        data={exercises}
        style={{
